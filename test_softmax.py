...
from cifar import Dataset as _daa
from common import WriteImages as wi

validation_percent=15   # Percentage to shave off for validation
...
da = _da.Datasets('/home/david/workspace/machine_learning/djl1/mnist_data', include_bias=1, validation_percent=validation_percent, zero_center=zero_center)
#da = _da.Datasets('/home/david/workspace/machine_learning/djl1/cifar_data', include_bias=1, validation_percent=validation_percent, zero_center=zero_center)
...
for i in range(batch_count):
    if i % 100 == 0:
        print 'loop ' + `i`
    data, labels = da.training.random_batch(batch_size)
...
wi.WriteImages.write(Wt_im, ['a','b'], '')
