...
Map::Map() {
  ...
  UP+RIGHT,LEFT+UP+RIGHT,LEFT+DOWN,DOWN,UP+RIGHT,LEFT+RIGHT,LEFT+UP+DOWN,RIGHT+DOWN,LEFT+UP,RIGHT+DOWN,LEFT+UP,RIGHT,LEFT+RIGHT,LEFT+RIGHT,LEFT+RIGHT/*here*/+DOWN,LEFT+UP,UP+RIGHT,LEFT,RIGHT,LEFT+DOWN,UP+DOWN,RIGHT,LEFT+DOWN,UP+RIGHT+DOWN,LEFT+DOWN,RIGHT,LEFT+RIGHT,LEFT+RIGHT+DOWN,LEFT+UP+RIGHT,LEFT+UP+DOWN,UP,DOWN,UP,UP,UP,UP,UP+RIGHT+DOWN,LEFT+DOWN,UP+RIGHT,LEFT+DOWN,RIGHT+DOWN,LEFT+RIGHT,LEFT+RIGHT+DOWN,LEFT,DOWN,UP,RIGHT,LEFT+UP,RIGHT,LEFT+UP+DOWN,
  RIGHT+DOWN,LEFT+RIGHT,LEFT+UP+DOWN,UP+RIGHT,LEFT+RIGHT+DOWN,LEFT+DOWN,UP+DOWN,UP,DOWN,UP+RIGHT+DOWN,LEFT+RIGHT,LEFT,DOWN,RIGHT+DOWN,LEFT+RIGHT+DOWN/*here*/+UP,LEFT+RIGHT,LEFT+RIGHT+DOWN,LEFT,RIGHT,LEFT+UP+RIGHT,LEFT+UP+DOWN,DOWN,UP+RIGHT,LEFT+UP,UP+RIGHT+DOWN,LEFT,RIGHT+DOWN,LEFT+UP,DOWN,UP+RIGHT,LEFT,UP+RIGHT+DOWN,LEFT+RIGHT,LEFT,RIGHT+DOWN,LEFT+RIGHT,LEFT+UP,UP+RIGHT,LEFT+DOWN,UP+RIGHT+DOWN,LEFT+UP,RIGHT,LEFT+UP,RIGHT+DOWN,LEFT+UP+RIGHT+DOWN,LEFT+RIGHT,LEFT+RIGHT,LEFT+RIGHT,LEFT+DOWN,UP+DOWN,
  ...
  RIGHT,LEFT+UP,UP+RIGHT,LEFT+RIGHT,LEFT+RIGHT,LEFT+UP,UP,UP+RIGHT,LEFT+UP+RIGHT,LEFT,UP/*here*/+DOWN,DOWN,UP+DOWN,RIGHT+DOWN,LEFT+UP,UP+RIGHT+DOWN,LEFT+UP+RIGHT,LEFT+UP,RIGHT+DOWN,LEFT+DOWN,UP+RIGHT+DOWN,LEFT,RIGHT+DOWN,LEFT,UP+RIGHT+DOWN,LEFT+DOWN,UP+DOWN,UP+RIGHT+DOWN,LEFT,UP,UP+RIGHT,LEFT+RIGHT+DOWN,LEFT+RIGHT,LEFT+RIGHT+DOWN,LEFT+RIGHT,LEFT+DOWN,UP,UP+DOWN,DOWN,UP,UP+RIGHT,LEFT+UP+RIGHT,LEFT+RIGHT+DOWN,LEFT+UP+DOWN,UP+RIGHT+DOWN,LEFT+UP,RIGHT,LEFT+UP+RIGHT+DOWN,LEFT+RIGHT,LEFT,
  DOWN,DOWN,RIGHT+DOWN,LEFT,RIGHT+DOWN,LEFT+RIGHT+DOWN,LEFT+RIGHT,LEFT+DOWN,DOWN,RIGHT+DOWN,LEFT+RIGHT/*here*/+UP,LEFT+UP,UP+DOWN,UP,RIGHT,LEFT+UP,RIGHT+DOWN,LEFT+DOWN,UP+DOWN,UP+DOWN,UP+RIGHT+DOWN,LEFT+DOWN,UP+RIGHT+DOWN,LEFT+RIGHT+DOWN,LEFT+UP+DOWN,UP+DOWN,UP,UP+RIGHT+DOWN,LEFT+DOWN,RIGHT+DOWN,LEFT+DOWN,UP+RIGHT,LEFT+DOWN,UP+DOWN,DOWN,UP,RIGHT,LEFT+UP+RIGHT,LEFT+UP+RIGHT,LEFT+RIGHT,LEFT+DOWN,RIGHT+DOWN,LEFT+UP,UP,UP+RIGHT,LEFT+DOWN,RIGHT,LEFT+UP+RIGHT,LEFT+RIGHT+DOWN,LEFT,
